...
void setup() { 
  ...
  Serial.println("Do not forget to set up port in Simple Socket IO");
  ...
  Serial.println("Make sure that the Simple Socket IO accepted the connection \"Accepted TCP connection from...\"");
